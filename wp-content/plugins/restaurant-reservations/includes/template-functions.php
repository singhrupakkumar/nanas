...
function rtb_print_form_text_field( $slug, $title, $value, $args = array() ) {
	...
	<div <?php echo rtb_print_element_class( $slug, $classes ); ?>>
		...
		<input type="<?php echo $type; ?>" placeholder="<?php if($slug =='name'){ echo "Enter your first name"; }elseif($slug =='lastname'){ echo "Enter your last name"; }elseif($slug =='email'){ echo "Enter your email"; }elseif($slug =='phone'){ echo "Enter your Phone number"; }elseif($slug =='time') { echo "Choose Time "; }else{ echo " "; } ?>" class="form-control" name="rtb-<?php echo $slug; ?>" id="rtb-<?php echo $slug; ?>" value="<?php echo $value; ?>"<?php echo $required; ?>>
	</div>
	</div>
...
function rtb_print_form_select_field( $slug, $title, $value, $args ) {
	...
	<div <?php echo rtb_print_element_class( $slug, $classes ); ?>>
		...
		<select name="rtb-<?php echo $slug; ?>" class="form-control" id="rtb-<?php echo $slug; ?>"<?php echo $required; ?>>

		...
		$fields = array(
			...
			'reservation'	=> array(
				...
				'fields'	=> array(
					...
					'time'		=> array(
						'title'			=> __( 'TIME IN:', 'restaurant-reservations' ),
						'request_input'	=> empty( $request->request_time ) ? '' : $request->request_time,
						'callback'		=> 'rtb_print_form_text_field',
						'required'		=> true,
					),
					'party'		=> array(
						'title'			=> __( 'NUMBER OF MEMBER:', 'restaurant-reservations' ),
			...
			'contact'	=> array(
				...
				'fields'	=> array(
					'name'		=> array(
						'title'			=> __( 'First Name', 'restaurant-reservations' ),
						'request_input'	=> empty( $request->name ) ? '' : $request->name,
						'callback'		=> 'rtb_print_form_text_field',
						'required'		=> true,
					),'lastname'		=> array(
						'title'			=> __( 'Last Name', 'restaurant-reservations' ),
						'request_input'	=> empty( $request->lastname ) ? '' : $request->lastname,
						'callback'		=> 'rtb_print_form_text_field',
						'required'		=> false,
					),
					'email'		=> array(
